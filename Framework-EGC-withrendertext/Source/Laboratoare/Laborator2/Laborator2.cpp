...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		Mesh *cube3 = CreateMesh("cube3", vertices, indices);
	}
	...
	{	
		...
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 0, 1)), //2
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 0, 1)), //3
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 0)), //4
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 0)), //5
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 0, 1)), //6
			...
			*/
			...
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1)), //4
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 1, 1)), //5
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1)), //6
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 1)), //7

			VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 2, 0)), //8
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 2, 0)), //9
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 2, 0)), //10
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 2, 0)), //11

			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 3, 0)), //12
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 3, 0)), //13
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 3, 0)), //14
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 3, 0)), //15

			VertexFormat(glm::vec3(0, 0, 1), glm::vec3(2, 0, 1)), //16
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(2, 0, 1)), //17
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(2, 0, 1)), //18
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(2, 0, 1)), //19

			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0, 1)), //20
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0, 1)), //21
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 0, 1)), //22
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 0, 1)), //23
		};
		...
		// Create a new mesh from buffer data
		Mesh* cubec = CreateMesh("cubec", vertices, indices);
	}
}
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(1.5f, 0, 0), glm::vec3(0.5f));

	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-1.0f, 1, 0), glm::vec3(0.5f));
	
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.2f, 0.5f, 0), glm::vec3(0.75f));

	RenderMesh(meshes["cubec"], shaders["VertexColor"], glm::vec3(-1, 0.25f, 0), glm::vec3(0.5f));
