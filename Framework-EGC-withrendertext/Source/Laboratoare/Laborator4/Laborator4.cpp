...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	// bonus
	//modelMatrix *= Transform3D::Translate(2.5f, 0.5f, -1.5f);
	//modelMatrix *= Transform3D::RotateOY(angularStepOYsecond);
	//modelMatrix *= Transform3D::Translate(-2.5f, -0.5f, 1.5f);
	//RenderMesh(meshes["box"], shaders["Simple"], modelMatrix);
...
{
	// move the first object with W, A, S, D, R, F
	...
	// move the second object with 1, 2
	...
	// move the third object with 3, 4, 5, 6, 7, 8
